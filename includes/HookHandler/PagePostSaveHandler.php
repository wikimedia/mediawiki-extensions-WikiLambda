...
/**
 * WikiLambda handler for hooks which react to page editing
 *
 * @file
 * @ingroup Extensions
...
class PagePostSaveHandler implements
	\MediaWiki\RecentChanges\Hook\RecentChange_saveHook
{
	...
	public function onRecentChange_save( $recentChange ) {
		...
		if ( !$newTargetZObject || !( $newTargetZObject instanceof ZObjectContent ) ) {
			// This isn't a ZObject, so we don't care.
			// var_dump( $newTargetZObject );
			return;
		}
